                        ...
                        {schools.map((s) => (
                            <tr key={s.id}>
                                ...
                                <td className="px-4 py-3 space-x-2 whitespace-nowrap">
                                    <button type="button" onClick={() => handleEdit(s)} className="text-blue-600 font-medium">Modifier</button>
                                    <button type="button" onClick={() => handleDelete(s.id)} className="text-red-600 font-medium">Supprimer</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
